 ...
 * Date: 3/23/2023
 * Description: Assignment 5 JSON class. This class is used to parse JSON files and create
 * JSON DOMs. It also has methods to marshal JSON DOMs into JSON files.
 */
// ----------------------------------------------------------------
